...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__stylesheets_style_less__ = __webpack_require__(3);
...
window.onload = () => {
  if (pathname == '/' ){
    __webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 6)).then(module => {
      module.default();
    });
  }else if(pathname == '/users/' ){
    __webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 7)).then(module => {
      module.default();
    });
  }
}
